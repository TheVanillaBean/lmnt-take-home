        ...
        {({ open }) => (
          <>
            ...
            <div className='relative mt-2 mb-12'>
              <Listbox.Button className='relative w-fit cursor-default rounded-md bg-white py-1.5 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:bg-white sm:text-sm sm:leading-6'>
